      ...
      <div class="border border-gray-200 bg-white shadow-md rounded-lg p-8 w-full max-w-lg">
        ...
        <form>
          ...
          <div class="flex mt-6 gap-x-4">
            ...
            <button
              type="submit"
              class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-500 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            >
              Cancel
            </button>
          </div>
